...
const translations = {
  en: {
    ...
    "story.a17": "Went all-in on the brand — built my own shipping systems and shipped every order myself.",
    "story.a18": "Dove into the world of apps and started building my own.",
    "story.two": "Building LOCK-IN — helping 50,000+ users beat their phone addiction.",
  ...
  de: {
    ...
    "stats.users": "Nutzer auf LOCK-IN",
    ...
    "story.one": "Eine Kleidermarke aus meinem Zimmer aufgebaut — über 10.000 verkaufte Artikel.",
    "story.a17": "Voll auf die Brand fokussiert — eigene Versandsysteme gebaut und jede Bestellung selbst verschickt.",
    "story.a18": "In die Welt der Apps eingetaucht — und angefangen, eigene zu bauen.",
    "story.two": "Ich baue LOCK-IN — und helfe schon 50.000+ Nutzern, ihre Handysucht zu besiegen.",
